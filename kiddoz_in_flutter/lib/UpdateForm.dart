...
class UpdateForm extends StatefulWidget {
  ...
  const UpdateForm({Key? key, required this.recommendation}) : super(key: key);
...
class _UpdateFormState extends State<UpdateForm> {
  ...
  void initState() {
    ...
    _titleController.text = widget.recommendation.title;
    _descriptionController.text = widget.recommendation.description;
    _ageController.text = widget.recommendation.age.toString();
    _benefitsController.text = widget.recommendation.benefits;
    selectedType = widget.recommendation.type.index;
  }
